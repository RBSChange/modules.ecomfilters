<?php
class ecomfilters_LastAbandonedOrderPeriodFilter extends f_persistentdocument_DocumentFilterImpl
{
	...
	public function getQuery()
	{
		...
		if ($type == 'more')
		{
			return customer_CustomerService::getInstance()->createQuery()->add(Restrictions::lt('lastAbandonedOrderDate', $date));
		}
		return customer_CustomerService::getInstance()->createQuery()->add(Restrictions::gt('lastAbandonedOrderDate', $date));
	}
	...
	public function checkValue($value)
	{
		if ($value instanceof customer_persistentdocument_customer)
		{
			...
			if ($type == 'more')
			{
				return $value->getLastAbandonedOrderDate() < $date;
			}
			return $value->getLastAbandonedOrderDate() > $date;
		}
		return false;
